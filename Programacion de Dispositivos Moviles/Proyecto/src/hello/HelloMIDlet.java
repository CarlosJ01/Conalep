...
//GEN-LINE:|7-commandAction|4|34-postAction
    ...
    public Form getForm() {
        if (form == null) {//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
            form = new Form("Promedio", new Item[] { getStringItem(), getTextField(), getTextField1(), getTextField2(), getTextField3(), getTextField4(), getTextField5(), getTextField6(), getTextField7(), getTextField8(), getImageItem() });//GEN-BEGIN:|14-getter|1|14-postInit
